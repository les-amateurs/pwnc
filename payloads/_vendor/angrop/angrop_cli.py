...
import angr
from . import rop as _rop
from pwnlib.elf import ELF


def new_rop_analysis(project):
    """Construct this embedded source tree's exact analysis class."""
    return project.analyses[_rop.ROP](fast_mode=False, max_sym_mem_access=1, only_check_near_rets=False)
